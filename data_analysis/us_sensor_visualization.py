...
plt.title("Ultrasonic Sensor Test")
plt.xlabel("Time (s)")
plt.ylabel("Distance (cm)")
plt.yticks([d for d in range(round(max(distances)) + 10) if d % 10 == 0])
plt.axhspan(0, 10, fc='b', alpha=0.1)
plt.axhspan(10, 20, fc='r', alpha=0.1)
plt.axhspan(20, 30, fc='g', alpha=0.1)
plt.axhspan(30, 120, fc='y', alpha=0.1)
plt.show()
